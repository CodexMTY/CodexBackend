class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      # params.fetch(:user, {})
      params.require(:user).permit(:nombre, :email, :password, :password_confirmation, :apellidos, :idm4, :cumpleanos, :fecha_ingreso, :universidad, :direccion, :puesto, :pc_cat, :resumen, :key_talent, :encuadre, :cet, :estructura3, :estructura4, :estructura5, :estudios => [])
    end
end
